...
function (_Component) {
  ...
  function Post() {
    ...
    _defineProperty(_assertThisInitialized(_this), "waitForPostContainer", function (content) {
      _this.timeoutId = setTimeout(function () {
        if (content) {
          _this.attachEvents(document.querySelector('.ant-layout-content'));

          var images = document.querySelectorAll('.blog-markdown img');
          console.log(document.querySelector('.blog-markdown'));
        ...
        var queryContent = document.querySelector('.blog-markdown');
  ...
  _createClass(Post, [{
    ...
    value: function componentDidMount() {
      var content = document.querySelector('.blog-markdown');
...
//# sourceMappingURL=post.js.a2079d2c94486c69dbb3.hot-update.js.map