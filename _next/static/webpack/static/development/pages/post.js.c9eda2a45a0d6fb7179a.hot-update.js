...
function (_Component) {
  ...
  function Post() {
    ...
    _defineProperty(_assertThisInitialized(_this), "attachEvents", lodash_throttle__WEBPACK_IMPORTED_MODULE_7___default()(function (content) {
      var centerHeight = content.target.clientHeight / 2;
      var postPrev = document.getElementById('post-prev');

      if (postPrev) {
        postPrev.style.top = "".concat(content.target.scrollTop + centerHeight, "px");
      }

      var postNext = document.getElementById('post-next');

      if (postNext) {
        postNext.style.top = "".concat(content.target.scrollTop + centerHeight, "px");
      }
...
//# sourceMappingURL=post.js.c9eda2a45a0d6fb7179a.hot-update.js.map