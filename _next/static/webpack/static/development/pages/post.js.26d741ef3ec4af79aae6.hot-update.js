  ...
  function Post() {
    ...
    _defineProperty(_assertThisInitialized(_this), "attachEvents", function (content) {
      content.addEventListener('scroll', function (e) {
        ...
        console.log(e.target.scrollTop + centerHeight);
        document.getElementById('post-prev').style.top = "".concat(e.target.scrollTop + centerHeight, "px");
        document.getElementById('post-right').style.top = "".concat(e.target.scrollTop + centerHeight, "px");
      });
    });
...
//# sourceMappingURL=post.js.26d741ef3ec4af79aae6.hot-update.js.map