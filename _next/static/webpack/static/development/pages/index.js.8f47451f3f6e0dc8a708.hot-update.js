  ...
  function BackTop() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onScroll", lodash_throttle__WEBPACK_IMPORTED_MODULE_5___default()(function (e) {
      ...
      if (e.target.scrollTop >= threshold) {
        _this.content.classList.add('visible');
        ...
        _this.timeoutId = setTimeout(function () {
          if (_this.content) {
            _this.content.classList.remove('visible');
          }
        }, 1500);
      } else {
        _this.content.classList.remove('visible');
  ...
  _createClass(BackTop, [{
    ...
    value: function componentDidMount() {
      var _this$props$target = this.props.target,
          target = _this$props$target === void 0 ? '.ant-layout-content' : _this$props$target;
...
//# sourceMappingURL=index.js.8f47451f3f6e0dc8a708.hot-update.js.map